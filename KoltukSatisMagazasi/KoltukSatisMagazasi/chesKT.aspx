<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanıcı.Master" AutoEventWireup="true" CodeBehind="chesKT.aspx.cs" Inherits="KoltukSatisMagazasi.chesKT" %>
...
<asp:Button ID="Button1" runat="server" Text="Sepete Ekle" OnClick="SepeteEkle_Click" />
                ...
                <div class="slide-item">
                    <div class="slide-content">
                        <img src="ches/.jpg" alt="Koltuk 3" class="slide-image" />
