<%@ Page Title="Ana Sayfa" Language="C#" MasterPageFile="~/Kullanıcı.master" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="KoltukSatisMagazasi.AnaSayfa" %>
...
<asp:Label ID="lblUrunFiyati" runat="server" Text="5500"></asp:Label>
<asp:Button ID="btnSepeteEkle" runat="server" Text="Sepete Ekle" OnClick="SepeteEkle_Click" />
                ...
                <div class="slide-item">
                    <div class="slide-content">
                      ...
                      <!-- AnaSayfa.aspx -->
<asp:Label ID="Label1" runat="server" Text="berjer"></asp:Label>
...
<asp:Button ID="Button1" runat="server" Text="Sepete Ekle" OnClick="SepeteEkle_Click" />
                ...
                <div class="slide-item">
                    <div class="slide-content">
                        <img src="ches/koltuk3.jpg" alt="Koltuk 3" class="slide-image" />
                        <p class="slide-caption">Armut Koltuk - Rahatlığı ve şıklığı bir arada sunar.</p>
                      <!-- AnaSayfa.aspx -->
<asp:Label ID="Label3" runat="server" Text="köşe koltuk"></asp:Label>
