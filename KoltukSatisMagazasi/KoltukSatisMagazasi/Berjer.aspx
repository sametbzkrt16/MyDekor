<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanıcı.Master" AutoEventWireup="true" CodeBehind="Berjer.aspx.cs" Inherits="KoltukSatisMagazasi.Berjer" %>
            ...
            <div class="slides">
                ...
                <div class="slide-item">
                    <div class="slide-content">
                        <img src="ches/angech.jpg" alt="Koltuk 1" class="slide-image" />
                        <p class="slide-caption">Köşe Koltuk Takımı - Modern ve şık tasarım.</p>
                        <asp:Label ID="lblUrunAdi" runat="server" Text="Köşe Koltuk Takımı"></asp:Label>
                ...
                <div class="slide-item">
                    <div class="slide-content">
                        ...
                        <asp:Label ID="lblUrunAdi2" runat="server" Text="Atalanta Koltuk"></asp:Label>
                        <asp:Label ID="lblUrunFiyati2" runat="server" Text="600"></asp:Label>
                        <asp:Button ID="btnSepeteEkle2" runat="server" Text="Sepete Ekle" OnClick="SepeteEkle_Click" />
                    </div>
                </div>
                <div class="slide-item">
                    <div class="slide-content">
                        <img src="ches/armut.jpg" alt="Koltuk 3" class="slide-image" />
                        <p class="slide-caption">Armut Koltuk - Rahatlığı ve şıklığı bir arada sunar.</p>
                        <asp:Label ID="lblUrunAdi3" runat="server" Text="Armut Koltuk"></asp:Label>
                        <asp:Label ID="lblUrunFiyati3" runat="server" Text="450"></asp:Label>
                        <asp:Button ID="btnSepeteEkle3" runat="server" Text="Sepete Ekle" OnClick="SepeteEkle_Click" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function showSlides() {
            ...
            if (isAutoSliding) {
                ...
                }, 3000); // 3 saniye arayla geçiş yap
            }
        }
